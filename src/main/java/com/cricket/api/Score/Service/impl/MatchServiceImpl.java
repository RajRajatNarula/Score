package com.cricket.api.Score.Service.impl;

import com.cricket.api.Score.Entities.Match;
import com.cricket.api.Score.Repositories.MatchRepo;
...
public class MatchServiceImpl implements MatchService {
    ...
    // List of all matches from our database
    @Override
    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            String noMatch = document.select("div.cb-font-16.cb-col-rt").text();
            System.out.println("4");
            if(noMatch.equals("There are no matches at the moment. Please check back later."))
            {
                System.out.println("NO MATCHES AT THIS MOMENT");
            }
